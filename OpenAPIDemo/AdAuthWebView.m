...
@interface AdAuthWebView (Private)
...
#pragma mark - AdAuthWebView Life Circle
...
#pragma mark - AdAuthWebView Public Methods
...
{
    NSLog(@"webViewrequest.URL===%@",request.URL.absoluteString);
